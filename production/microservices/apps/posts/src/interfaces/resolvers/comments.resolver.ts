...
export class CommentsResolver {
  constructor(
    private readonly commentsService: CommentsUseCase,
  ...
  createReply(
    ...
    return this.commentsService.addReplyToPostComment({
      ...createReplyInput,
      userId: user.sub,
    });
  }
  ...
  getByParentComment(
    @Args('getRepliesByCommentInput') getByPostInput: GetByParentCommentInput,
  ) {
