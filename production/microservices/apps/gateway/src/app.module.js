...
var auth_context_1 = require("./auth/auth.context");
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                config_1.ConfigModule.forRoot({
                    ...
                    inject: [authConfig_1.default.KEY],
                ...
                graphql_1.GraphQLModule.forRootAsync({
                    ...
                    inject: [config_1.ConfigService, auth_context_1.AuthContext],
                    useFactory: function (config, authContext) {
                        return {
                            server: {
                                context: function (_a) {
                                    var req = _a.req;
                                    return authContext.validate({ req: req });
                                }
                            },
                            gateway: {
