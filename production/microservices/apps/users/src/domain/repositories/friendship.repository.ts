...
export abstract class FriendshipRepository {
  abstract create(createUserInput: CreateFriendshipDto): Promise<FriendshipEntity>

  abstract findByUser(fields: FindUserFriendshipsDto): Promise<FriendshipEntity[]>
  ...
  abstract findUsersFriendship(fields: FindUsersFriendshipDto): Promise<FriendshipEntity>

  abstract update(updateFriendshipDto: UpdateFriendshipDto): Promise<FriendshipEntity>
