...
import { useEditorRef, useEditorState, usePlateStates } from "@udecode/plate-common/react";
import { Input } from "@/shared/ui/input";
import { Button } from "@/shared/ui/button";

import { useUpdatePostMutation, useRegisterMutation } from "@/shared/api/graphql/generated";
...
const UpdateWork = () => {
  ...
  const { mutate: createPost } = useUpdatePostMutation(graphqlClient, {
    onSuccess: (data) => {
      console.log(data)
    }
  });
