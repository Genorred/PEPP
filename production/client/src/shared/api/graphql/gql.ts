 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n    query getUserFriendships($userId: Int!, $cursorid: Int) {\n        userFriends(findFriendsByUserInput: {\n            userId: $userId\n            cursorId: $cursorid\n        }) {\n            senderId\n            receiverId\n            anotherUser {\n                id\n                username\n                img\n            }\n        }\n    }\n"): typeof import("./graphql").GetUserFriendshipsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n    query getUserFriendshipsCount($userId: Int!) {\n        userFriendsQuantity(countFriendshipInput: {\n            userId: $userId\n        })\n    }\n"): typeof import("./graphql").GetUserFriendshipsCountDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
